...
import sys 
sys.path.append('/Users/berntisak/Code/art-projects/co-creative-spaces/cccp/offline/cccp')

import cccp as cp

# instansier et CSS-objekt basert p� test-sound.wav og test-sound.ccs (eksisterer alltid i par)
percussionImpro = cp.open("sounds/morten-02")

# kj�r segmentering
slicer = cp.segmenters.NoveltySlice(feature=0, threshold=0.5, filtersize=1, kernelsize=1, fftparams=[1024, -1, -1], min_length=2)
...
for seg in segmentation.segments:
    if seg.duration < 3.0 and seg.duration > 0.1:
